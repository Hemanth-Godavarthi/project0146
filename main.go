...
func init() {
	pterm.Println()
	str := pterm.DefaultHeader.WithBackgroundStyle(pterm.NewStyle(pterm.BgRed)).WithMargin(10).Sprintf("project0146")
...
func main() {
	...
	if r.User != nil {
		pterm.Printfln("[%s] Name : %s", pterm.Green("+"), pterm.Green(r.Name))
